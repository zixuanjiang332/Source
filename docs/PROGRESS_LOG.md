...
- 接入玩家动画控制接口，并定义“源”早期克隆体第一轮正式动作帧规格。
- 生成并接入主角“源”早期克隆体 66 帧 AI 最终运行时动画素材。

### 当前阻塞

- 正式主角、武器和特效风格尚待负责人最终确认。
...
| 主角视觉草案 | 美术/VFX | Done | 早期克隆体 66 帧 AI final runtime spritesheet 已接入，后续可人工精修替换 |
| 武器视觉草案 | 策划 / 美术 | Review | 武器轮廓参考已入库，等待确认是否直接接入或重绘 |
