...
当前骨架提供可跑的灰盒切片：脸部主题标题菜单、玩家动作帧、移动、跳跃、冲刺、初始匕首三段攻击、Demo 能量技 `Flash Step`、Hitbox/Hurtbox、敌人受击/死亡、掉落道具、镜头震动、大视距相机、地图边界、武器/能量/连段 HUD、已接入的“源”主角/HUD/武器视觉资源、实验室动态背景、赛博朋克城市占位段、命中特效和动态背景 props 框架。
